...
# v0.20.21
# ==========================================
# Example 04: Echo Task Learning
# ==========================================
# Goal: Demonstrate adaptive Hebbian-Volterra style learning on delayed-echo tasks.
# Runtime: Variable (depends on epochs/settings).
# Outputs: Training diagnostics and echo reconstruction plots/metrics (script-defined).
# Status: Core adaptive-learning demonstration.

using Markdown
using InteractiveUtils

# ╔═╡ 91530415-5b10-4676-a2db-177233bb7f5c
#=╠═╡
import DifferentialEquations 
  ╠═╡ =#

# ╔═╡ 9628084a-7939-44d5-bbfd-183c00ac35f0
for i in 1:10
	i<8 && continue
	println(i)
end

# ╔═╡ 6139f50f-6692-42e7-acf7-9d44f3435c9c
while true
	x = rand()
	println(x)
	x < 0.1 && break
...
# ╔═╡ 95b731ac-01c2-11f1-aaf2-1b318d54d72e
function f(x::Float64) 
	return x^2 + 2x + 1 
end

# ╔═╡ 9247fa1a-bfb6-431d-ac90-d3c894560fe5
f(2.0)

# ╔═╡ 1709c70f-264f-45e1-9168-c26ae9b402d2
function fvec(x::Vector{Float64})
	return x .^ 2 .+ 2 .* x .+ 1
end

# ╔═╡ 07d08ec7-96cd-40e2-90f9-253b3465b0e6
fvec([1.0, 2.0, 3.0])

# ╔═╡ 3cbeeab8-3429-417f-bbfa-af82717042a5
function MemoryChannel(y::Float64,w::Float64)
	return MemoryChannel(y,w,0.0)
end

# ╔═╡ c713808c-5bb2-476a-b6d8-b1ec90c55223
function decay!(dy,y,p,t)
	Y=p
	dy[1]=-Y*y[1]
end

# ╔═╡ bc985197-cb31-492f-ab95-fd99bd71bf72
# ╠═╡ disabled = true
#=╠═╡
begin
	using PlotyLight
	y0=[1,0]
	tspan=(0.0,10.0)
	prob= ODEProblem(decay!,y0,tspan,0.5)
	sol=solve(prob,Tsit())
...
manifest_format = "2.0"
project_hash = "14e7efc830ef23e16e8e4a9e269db6565a18fd65"
...
git-tree-sha1 = "b5d6f3ac96d3b61e5e9b6eafdbdf1fb739d367d6"
